...
namespace NitroxModel.DataStructures.ServerModel
{
    public class VehicleModel
    {
        ...
        public VehicleModel(TechType techType, Guid guid, Vector3 position, Quaternion rotation, Vector3 velocity, Vector3 angularVelocity, float steeringWheelYaw, float steeringWheelPitch, bool appliedThrottle)
        {
